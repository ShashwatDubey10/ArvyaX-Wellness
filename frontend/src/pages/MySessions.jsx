  ...
  const handleDelete = (id, title) => {
    toast.custom((t) => (
      <div className="bg-white rounded-xl shadow-xl p-6 text-gray-900 flex flex-col items-center min-w-[260px] z-50">
        <div className="mb-3 font-semibold text-lg text-emerald-600">Delete session?</div>
        <div className="mb-3 text-sm text-gray-700 text-center">
          Are you sure you want to delete <span className="font-bold">"{title}"</span>?<br />
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-800 font-montserrat select-none">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10">
        ...
        <div className="absolute bottom-40 right-32 w-28 h-28 rounded-full bg-emerald-400/20 animate-bounce" style={{ animationDuration: "3.5s" }} />
        <div className="absolute top-1/2 left-12 w-20 h-20 rounded-full bg-emerald-600/20 animate-ping" style={{ animationDuration: "5s" }} />
      ...
      <div className="relative max-w-7xl mx-auto p-8 md:p-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
          <div>
            <h1 className="text-4xl font-extrabold tracking-tight drop-shadow-md text-white">My Sessions</h1>
            <p className="mt-2 text-lg text-emerald-200/80">
              All your created sessions with quick access to edit, publish, or delete.
            </p>
          </div>
          {/* New Session */}
          <Link
          ...
          >
            <svg viewBox="0 0 24 24" width={20} height={20} fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-1 stroke-white stroke-[1.5px]">
              <path d="M15 12L12 12" strokeLinecap="round" /><path d="M12 12L9 12" strokeLinecap="round" />
              <path d="M12 12L12 9" strokeLinecap="round" /><path d="M12 12L12 15" strokeLinecap="round" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="text-center py-6 bg-white/10 border border-white/20 rounded-2xl shadow">
            <div className="text-3xl font-bold text-emerald-300">{sessions.length}</div>
          ...
          <div className="text-center py-6 bg-white/10 border border-white/20 rounded-2xl shadow">
            ...
            <div className="mt-1 text-lg text-white font-semibold">Published</div>
          </div>
          <div className="text-center py-6 bg-white/10 border border-white/20 rounded-2xl shadow">
            <div className="text-3xl font-bold text-emerald-200">{draftCount}</div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-10">
          ...
          <div className="relative w-full md:w-auto">
            ...
            >
              <option className="bg-slate-900 text-emerald-200" value="all">All Status</option>
              <option className="bg-slate-900 text-emerald-300" value="published">Published</option>
              <option className="bg-slate-900 text-amber-200" value="draft">Draft</option>
            </select>
            {/* Animated SVG arrow */}
            <span className="
            ...
            >
              <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
                <path d="M6 8l4 4 4-4" stroke="#34D399" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </span>
          </div>
        </div>
        ...
        {/* Sessions Grid */}
        {loading ? (
          <div className="text-center py-20 text-emerald-200/80">Loading your sessions...</div>
          ...
          <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl shadow-2xl p-16 text-center relative overflow-hidden">
            <p className="text-lg text-white">No sessions found. Try a different search or create new sessions!</p>
            ...
            {filteredSessions.map((session) => (
              ...
              >
                ...
                <p className="text-sm text-emerald-200 truncate mb-4">
                  {Array.isArray(session.tags) && session.tags.length > 0 ? session.tags.join(", ") : "No tags"}
                </p>
