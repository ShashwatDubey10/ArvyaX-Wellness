...
const Sessions = () => {
  ...
  const filteredSessions = sessions.filter((session) => {
    ...
    const matchesTag =
      !selectedTag || (session.tags || []).includes(selectedTag);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-800 font-montserrat">
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-3/4 right-1/4 w-24 h-24 bg-emerald-400/3 rounded-full animate-bounce"
          style={{ animationDuration: "4s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/6 w-16 h-16 bg-emerald-600/5 rounded-full animate-ping"
          style={{ animationDuration: "5s" }}
        ></div>
        <div
          className="absolute bottom-1/4 right-1/6 w-20 h-20 bg-emerald-300/4 rounded-full animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/6 right-1/2 w-12 h-12 bg-emerald-700/6 rounded-full animate-bounce"
        ...
        <div
          className="absolute -bottom-32 -right-32 w-96 h-96 bg-gradient-to-l from-emerald-600/10 to-transparent rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-emerald-500/5 to-emerald-300/5 rounded-full blur-2xl animate-pulse"
          ...
          <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl shadow-2xl p-12 mb-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl md:text-2xl text-emerald-200/80 mb-8 max-w-3xl mx-auto leading-relaxed">
                Discover transformative wellness experiences from our community
                of practitioners. Find your path to mindfulness, healing, and
                inner peace.
              </p>
          ...
          {loading ? (
            <div className="flex flex-col items-center py-20">
              <div className="relative">
                ...
                <div
                  className="absolute top-2 left-2 w-16 h-16 border-4 border-emerald-400 border-t-transparent rounded-full animate-spin"
                  style={{
              ...
              <p className="text-emerald-200 text-lg mt-6 animate-pulse">
                Loading wellness sessions...
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl shadow-2xl p-16 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="w-24 h-24 mx-auto mb-6 relative">
                  ...
                  <div
                    className="absolute inset-2 bg-emerald-500/30 rounded-full animate-pulse"
                    style={{ animationDelay: "0.5s" }}
                  ></div>
                  <div
                    className="absolute inset-4 bg-emerald-600/40 rounded-full animate-pulse"
                    style={{ animationDelay: "1s" }}
                  ></div>
                </div>
                ...
                >
                  <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl shadow-xl p-6 relative overflow-hidden transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-emerald-500/20 group-hover:scale-105 group-hover:border-emerald-400/50">
                    ...
                    <div className="relative z-10">
                      ...
                      <div
                        className={`absolute -top-2 -right-2 w-6 h-6 bg-emerald-400/30 rounded-full transition-all duration-500 ${
                          hoveredSession === session._id
